...
---
## Step 26 - Terraform AWS - Provisioning, execute list over ssh connection automatic
...
---
## Step 27 - Terraform AWS - Provisioning, execute script ssh connection automatic
